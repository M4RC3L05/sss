...
export type RouteIncomingMessage = IncomingMessage & RouteRequestExtras;
...
export type NodeMiddleware = (request: IncomingMessage, response: ServerResponse, next: Next) => Promise<void> | void;
...
export type NodeRouteMiddleware = (request: RouteIncomingMessage, response: ServerResponse, next: Next) => Promise<void> | void;
export type WebRouteMiddleware = (request: RouteRequest, next: Next) => Promise<Response> | Response;
...
export type NodeHandler = (request: IncomingMessage, response: ServerResponse) => Promise<void> | void;
